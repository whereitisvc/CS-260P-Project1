...
/*	COMPARE( 0,n ) initializes a random array 					*/
/*			(indexed from 1 to n) of length n					*/
/*				all distinct values								*/
/*		returns  0 normally										*/
...
/*  *  *  *  *  *  *  *  *  *  *  *  *  *  *  *  *  *  *  *  *  */
	...
	if (arg1==0) {
		...
		/*
		printf("\n\nnumbers = ");
		for(int i=1; i<=arg2; i++) printf("%2d, ", number[i]);
		printf("\n\n\n");
		*/
	...
	if (arg1==-1) {
		...
		/*
		printf("\n\nnumbers[Best[i]] = ");
		for(int i=0; i<arg2; i++) printf("%2d, ", number[Best[i]]);
		printf("\n\n\n");
		*/
...
double dshrandom( ) {
/*  *  *  *  *  *  *  *  *  *  *  *  *  *  *  *  *  *  *  *  *  */
/*	generates random floating point values in the range [0,1)	*/
